...
let colors_name = "phoria256"
"}}}
" Colours {{{1
"" General {{{2
hi Normal       ctermfg=254 guifg=#d0d0d0 ctermbg=none guibg=#1c1c1c cterm=none gui=none
...
hi LineNr       ctermfg=249 guifg=#9e9e9e ctermbg=232 guibg=#121212
...
hi StatusLine   ctermfg=249  guifg=#ffffff ctermbg=232 guibg=#4e4e4e cterm=bold gui=bold
...
hi TabLineFill  ctermfg=fg  guifg=fg      ctermbg=232 guibg=#3a3a3a cterm=none gui=none
" FIXME
hi Title        ctermfg=225 guifg=#ffdfff
hi Todo         ctermfg=0   guifg=#000000 ctermbg=191 guibg=#dfdf00
...
hi Comment      ctermfg=246 guifg=#808080 
hi Constant     ctermfg=230 guifg=#ffffaf
hi Identifier   ctermfg=147 guifg=#dfafdf                           cterm=none
hi Ignore       ctermfg=238 guifg=#444444
hi Number       ctermfg=174 guifg=#dfaf87
hi PreProc      ctermfg=103 guifg=#afdf87
hi Special      ctermfg=174 guifg=#df8787
hi Statement    ctermfg=152 guifg=#87afdf                           cterm=none gui=none
hi Type         ctermfg=194 guifg=#afafdf                           cterm=none gui=none

"" Special {{{2
""" .diff {{{3
hi diffAdded    ctermfg=150 guifg=#afdf87
hi diffRemoved  ctermfg=157 guifg=#df8787
""" vimdiff {{{3
